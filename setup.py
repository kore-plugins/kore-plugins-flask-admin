...
init_path = os.path.join('kore_plugins_flask_admin', '__init__.py')
...
entry_points = """\
[kore.components]
kore.components.flask_admin =\
    kore_plugins_flask_admin.plugins.admin:FlaskAdminPluginComponent
"""


setup(
    name='kore-plugins-flask-admin',
    version=metadata['version'],
    author=metadata['author'],
    author_email=metadata['email'],
    url=metadata['url'],
    packages=find_packages(include=('kore_plugins_flask_admin*',)),
